...
include_once plugin_dir_path(__FILE__).'rating.php'; // Rating Functionality
//include_once plugin_dir_path(__FILE__).'deactivate.php'; // Plugin deactivation functionality
register_activation_hook( __FILE__, array( 'JEM_Table_Rating_Review_Feedback', 'jem_table_rate_activate' ) ); // set plugin installation date on plugin activation
...
console.log('test NISL 2');
                ...
                public function generate_shipping_list_html() {
                    ...
                    <!-- Calling a function which displays rating message on screen -->
                    <?php JEM_Table_Rating_Review_Feedback::display_message_on_screen(); ?>
